...
{
    public class GdaxPriceDataService : IPriceDataService
    {
        ...
        public GdaxPriceDataService(IWebSocketTransport webSocketTransport, IPollingPriceService priceQueryService, ISerialize jsonSerializer)
        {
